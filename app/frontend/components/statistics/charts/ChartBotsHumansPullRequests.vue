<template>
    <graph-card icon="fa-code-pull-request" title="Pull requests submitted" subtitle="past 60 days" :loading="loading">
        <canvas id="bots-humans-pull-requests-chart" width="350" height="350"></canvas>
    </graph-card>
</template>
...
export default {
    name: 'ChartBotsHumansPullRequests',
    ...
    created() {
        ...
        axios.post('/api/comparison/pull-requests', {
            ...
            new Chart('bots-humans-pull-requests-chart', {
                type: 'bar',
                data: {
                    labels: days,
                    datasets: [
