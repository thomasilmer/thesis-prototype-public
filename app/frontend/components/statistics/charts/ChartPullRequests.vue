<template>
    <graph-card icon="fa-code-pull-request" title="Pull requests submitted by bots" subtitle="past 60 days" :loading="loading">
        <canvas id="pull-requests-chart" width="350" height="350"></canvas>
    </graph-card>
</template>
            ...
            new Chart('pull-requests-chart', {
                ...
                data: {
                    ...
                    datasets: [
                        ...
                        {
                            label: 'Opened',
                            backgroundColor: GitHub.colors.pr.open(1),
                            borderColor: GitHub.colors.pr.open(1),
                            data: slices[2].map((item) => item.transitionCount),
                        },
                    ],
                },
                options: {
