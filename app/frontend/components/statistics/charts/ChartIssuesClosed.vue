<template>
    <graph-card icon="fa-bug" title="Issues closed by bots" subtitle="past 60 days" :loading="loading">
        <canvas id="issues-closed-chart" width="350" height="350"></canvas>
    </graph-card>
</template>
