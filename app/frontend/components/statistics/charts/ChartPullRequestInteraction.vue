<template>
    <graph-card icon="fa-arrow-right-arrow-left" title="Bot comments in human pull requests" subtitle="past 60 days" :loading="loading">
        <canvas id="pull-request-interaction-chart" width="350" height="350"></canvas>
    </graph-card>
</template>
...
export default {
    name: 'ChartPullRequestInteraction',
    ...
    created() {
        ...
        axios.post('/api/interaction/pull-requests', {
            ...
            new Chart('pull-request-interaction-chart', {
                type: 'line',
                data: {
                    labels: days,
                    datasets: [
                        {
                            label: 'New pull requests by humans',
                        ...
                        {
                            label: '# of bot comments in pull requests opened that day',
